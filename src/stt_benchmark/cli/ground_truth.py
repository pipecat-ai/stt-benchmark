...
def import_command(
    ...
    test: bool = typer.Option(
        ...
        "--test",
        "-t",
        help="Import to test database (test_results.db) instead of main database",
    ),
):
    ...
    Use --test to import ground truth into the test database for test runs.
    """
    import json
    ...
    if test:
        console.print("[yellow]Importing to test database[/yellow]")
