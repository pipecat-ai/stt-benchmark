    ...
    async def get_service_summary(
        ...
        cursor = await self._conn.execute(
            ...
            SELECT
                ...
                SUM(w.substitutions + w.deletions + w.insertions) as total_errors,
                SUM(w.reference_words) as total_ref_words
            FROM wer_metrics w
        ...
        # Calculate pooled WER (weighted by utterance length)
        total_errors = row["total_errors"] or 0
        total_ref_words = row["total_ref_words"] or 0
